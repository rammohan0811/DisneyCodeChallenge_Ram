...
class NonReserveGuestAdapter(private val onItemClicked: (NonReservedGuest) -> Unit) : RecyclerView.Adapter<NonReserveGuestAdapter.GuestViewHolder>(){

    private var data : MutableList<NonReservedGuest>?=null

    fun setData(list: MutableList<NonReservedGuest>){
        data = list
    ...
    class GuestViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView){
        fun bindView(item: NonReservedGuest?, position: Int) {
            if (item != null) {
